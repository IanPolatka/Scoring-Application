    ...
    <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="home_team_id" id="home_team_id" class="form-control" onChange="window.location.href=this.value">
                            ...
                            @foreach($teams as $team)
                                ...
                                <option value="/softball/{{ $year }}/{{ $team->school_name }}" @if ($selectedteamid[0] === $team->id) selected @endif>
                                    {{ $team->school_name }}
                                </option>
        ...
        <div class="col-md-5 col-md-offset-2">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><strong>Softball Schedule</strong></div>
                    <ul class="list-group">
                        @forelse ($softball as $item)
                            ...
                            <li class="list-group-item">
                                ...
                                @else
                                    ...
                                    @endif
                                    vs <a href="/softball/{{ $selectedyear[0] }}/{{ $item['away_team']['school_name'] }}">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><strong>JV Softball Schedule</strong></div>
                    <ul class="list-group">
                        @forelse ($jvsoftball as $item)
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><strong>Freshman Softball Schedule</strong></div>
                    <ul class="list-group">
                        @forelse ($freshsoftball as $item)
